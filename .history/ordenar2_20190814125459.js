...
function ordenar() {
    ...
    var eliminarHojasRepetidas = tallo.filter(function (item, index, array) {
        return array.indexOf(item) === index;
    })
    for (var i = 0; i < eliminarHojasRepetidas.length; i++) {
        var test = document.createElement("LI");
        var test2 = document.createTextNode(eliminarHojasRepetidas[i]);
        test.appendChild(test2);
   ...
   var medianaImprimir = document.createElement("LI");
    ...
    for(i = 0; i<tallo.length; i++){
        console.log(tallo[i] + " -");
        console.log("  |");
        for(j = 0; j<hoja.length; i++){
            console.log("--");
            console.log(tallo[i] +" ");
            console.log("  |");
        }
